...
var propTypes = _extends({}, _Calendar.default.ControlledComponent.propTypes, {
   ...
   */
  availableTimes: _propTypes.default.shape({
    hours: _propTypes.default.arrayOf(_propTypes.default.number),
    includeLastStep: _propTypes.default.bool
  }),
...
function (_React$Component) {
  ...
  _proto.renderTimeList = function renderTimeList() {
    ...
    var _this$props5 = this.props,
        ...
        availableTimes = _this$props5.availableTimes;
    return _react.default.createElement(_Popup.default, {
      dropUp: dropUp,
      transition: popupTransition,
      open: open === 'time',
...
function getDates(_ref2) {
  var step = _ref2.step,
      ...
      availableTimes = _ref2.availableTimes,
      props = _objectWithoutProperties(_ref2, ["step", "culture", "availableTimes"]);

  if (availableTimes) {
    return fetchAvailableTimes(_extends({
      step: step,
      culture: culture,
      availableTimes: availableTimes
    }, props));
  ...
  return fetchDefaultTimes(_extends({
    step: step,
    culture: culture
  }, props));
}

function fetchDefaultTimes(_ref3) {
  var step = _ref3.step,
      culture = _ref3.culture,
      props = _objectWithoutProperties(_ref3, ["step", "culture"]);
...
function fetchAvailableTimes(_ref4) {
  var step = _ref4.step,
      culture = _ref4.culture,
      availableTimes = _ref4.availableTimes,
      props = _objectWithoutProperties(_ref4, ["step", "culture", "availableTimes"]);

  var times = [];

  var _getBounds2 = getBounds(props),
      min = _getBounds2.min,
      max = _getBounds2.max;
